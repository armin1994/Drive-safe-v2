...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    showSwal: function(type){
    	...
    	}else if(type == 'success-registration'){
            swal({
                title: "Success!",
        ...
        else if(type == 'success-add-to-cart'){
            swal({
                title: "Success!",
                text: "You have successfully added scenario to cart!",
                buttonsStyling: false,
                confirmButtonClass: "btn btn-success",
                type: "success"
            });
        }
        else if(type == 'success-remove-from-cart'){
            swal({
                title: "Success!",
                text: "You have successfully removed scenario from cart!",
                buttonsStyling: false,
                confirmButtonClass: "btn btn-success",
                type: "success"
            });
        }
        else if(type == 'success-review'){
            swal({
                title: "Success!",
                text: "You have successfully added a review!",
                buttonsStyling: false,
                confirmButtonClass: "btn btn-success",
                type: "success"
            });
        }
        else if(type == 'success-edit-profile'){
            swal({
                title: "Success!",
        ...
        else if(type == 'success-remove-from-reservation'){
            swal({
                title: "Success!",
                text: "You have successfully removed scenario from reservation!",
                buttonsStyling: false,
                confirmButtonClass: "btn btn-success",
                type: "success"
            });
        }
        else if(type == 'success-remove-reservation'){
            swal({
                title: "Success!",
                text: "You have successfully removed pending reservation!",
                buttonsStyling: false,
                confirmButtonClass: "btn btn-success",
                type: "success"
            });
        }
        else if(type == 'success-reservation'){
            swal({
                title: "Success!",
    ...
    initGoogleMaps: function(){
        var myLatlng = new google.maps.LatLng(36.8983963, 10.1875433);
        var mapOptions = {
          zoom: 17,
          center: myLatlng,
